...
<section class="hero">
  ...
  <div class="hero-content">
    <div class="hero-text">
      ...
      <h1 class="hero-title">
        Rakit Setup<br>
        <span class="accent">PC Impian</span><br>
        Kamu<span class="accent-2">.</span>
      </h1>
    ...
    <div class="hero-visual">
      <div class="hero-card-main">
        <img class="hero-img-dark" src="images/hero_setup_banner.png" alt="PC Setup Impian" style="width:100%;object-fit:cover;">
        <img class="hero-img-light" src="images/hero_setup_banner_light.png" alt="PC Setup Impian" style="width:100%;object-fit:cover;">
      </div>
  ...
  <div class="container">
    <div class="section-header section-header-row">
      <div>
        ...
        <h2 class="section-title">Penawaran <span>Minggu Ini</span></h2>
...
<section class="solutions-section">
  <div class="container">
    ...
    <div class="solutions-grid">
      ...
      <a href="solutions.php#<?= htmlspecialchars($sol['slug']) ?>" class="solution-card" id="home-<?= htmlspecialchars($sol['slug']) ?>">
...
<section class="brands-section">
  <div class="container">
    <div class="section-header" style="text-align:center;">
      ...
      <h2 class="section-title">Brand <span>Pilihan Terbaik</span></h2>
    </div>
